...
export const GridPuzzle = () => {
  ...
  const [headerImage, setHeaderImage] = useState('https://i.imgur.com/BTmWSUc.jpeg');
  ...
  return (
    <div className="min-h-screen bg-neutral-50 w-full overflow-auto">
      ...
      <div className="flex flex-col items-center pt-[20px] relative">
        ...
        >
          <img 
            src="https://i.imgur.com/BTmWSUc.jpeg" 
            alt="Header"
            className="w-[200px]"
          />
        </a>
                ...
                <RadioGroup value={orderType} onValueChange={(value) => setOrderType(value as "regular" | "magnetic")}>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="magnetic">
                      {getOrderTitle()} M (pločice s čičak trakom za mogućnost mijenjanja kompozicije po želji) - {((imageCounts.S0 * 7) + (imageCounts.S1 * 12) + (imageCounts.S2 * 12) + (imageCounts.S0 + imageCounts.S1 + imageCounts.S2) * 3).toFixed(2)}€
                    </Label>
                  </div>
                </RadioGroup>
